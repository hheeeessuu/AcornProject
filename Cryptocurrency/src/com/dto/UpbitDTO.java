...
public class UpbitDTO {
	...
	public UpbitDTO(String upbit_pk, String upbit_date, String market, double opening_price, double high_price,
			double low_price, double trade_price, double prev_closing_price, String change, double change_price,
	...
	public String toString() {
		return "UpbitDTO [upbit_pk=" + upbit_pk + ", upbit_date=" + upbit_date + ", market=" + market
				...
				+ ", trade_price=" + trade_price + ", prev_closing_price=" + prev_closing_price + ", change=" + change
